...
class AbstractCollectionFieldValueChangerTest {
    ...
    Stream<DynamicTest> Should_Return_True_Or_False_Whether_Can_Change_Or_Not() throws NoSuchFieldException {
        return Stream.of(new CanChangeCase(new ArrayListValueChanger(),
                                           Collections.class.getDeclaredField("arrayList"),
                                           true),
                         new CanChangeCase(new DequeValueChanger(), Collections.class.getDeclaredField("deque"), true),
                         new CanChangeCase(new HashSetValueChanger(),
                                           Collections.class.getDeclaredField("hashSet"),
                                           true),
                         new CanChangeCase(new LinkedHashSetValueChanger(),
                                           Collections.class.getDeclaredField("linkedHashSet"),
                                           true),
                         new CanChangeCase(new LinkedListValueChanger(),
                                           Collections.class.getDeclaredField("linkedList"),
                                           true),
                         ...
                         new CanChangeCase(new SortedSetValueChanger(),
                                           Collections.class.getDeclaredField("sortedSet"),
                                           true),
                         new CanChangeCase(new StackValueChanger(), Collections.class.getDeclaredField("stack"), true),
                         new CanChangeCase(new TreeSetValueChanger(),
                                           Collections.class.getDeclaredField("treeSet"),
                                           true),
                         new CanChangeCase(new VectorValueChanger(),
                                           Collections.class.getDeclaredField("vector"),
                                           true))
    ...
    Stream<DynamicTest> Should_Return_True_Or_False_Whether_Values_Are_Different_Or_Not() {
        ...
        return Stream.of(new AreDifferentCase(new ArrayListValueChanger(), null, null, false),
                         ...
                         new AreDifferentCase(new ArrayListValueChanger(),
                                              new ArrayList<>(collectionAB),
                                              arrayListABC,
                                              true),
                         ...
                         new AreDifferentCase(new DequeValueChanger(),
                                              new LinkedList<>(collectionAB),
                                              linkedListABC,
                                              true),
                         ...
                         new AreDifferentCase(new HashSetValueChanger(),
                                              new HashSet<>(collectionABC),
                                              new HashSet<>(collectionABC),
                                              false),
                         new AreDifferentCase(new HashSetValueChanger(), null, new HashSet<>(), true),
                         new AreDifferentCase(new HashSetValueChanger(),
                                              new HashSet<>(collectionAB),
                                              new HashSet<>(collectionABC),
                                              true),
                         new AreDifferentCase(new LinkedHashSetValueChanger(), null, null, false),
                         new AreDifferentCase(new LinkedHashSetValueChanger(),
                                              new LinkedHashSet<>(),
                                              new LinkedHashSet<>(),
                                              false),
                         new AreDifferentCase(new LinkedHashSetValueChanger(),
                         ...
                         new AreDifferentCase(new LinkedHashSetValueChanger(),
                                              new LinkedHashSet<>(collectionAB),
                                              linkedHashSetABC,
                                              true),
                         new AreDifferentCase(new LinkedListValueChanger(), null, null, false),
                         new AreDifferentCase(new LinkedListValueChanger(),
                                              new LinkedList<>(),
                                              new LinkedList<>(),
                                              false),
                         ...
                         new AreDifferentCase(new ListValueChanger(),
                                              new ArrayList<>(collectionAB),
                                              arrayListABC,
                                              true),
                         ...
                         new AreDifferentCase(new QueueValueChanger(),
                                              new LinkedList<>(collectionAB),
                                              linkedListABC,
                                              true),
                         ...
                         new AreDifferentCase(new SetValueChanger(),
                                              new HashSet<>(collectionABC),
                                              new HashSet<>(collectionABC),
                                              false),
                         ...
                         new AreDifferentCase(new SortedSetValueChanger(),
                                              new TreeSet<>(collectionAB),
                                              treeSetABC,
                                              true))
