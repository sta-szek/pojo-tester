...
class AbstractMapFieldValueChangerTest {
    ...
    Stream<DynamicTest> Should_Return_True_Or_False_Whether_Can_Change_Or_Not() throws NoSuchFieldException {
        return Stream.of(new CanChangeCase(new HashtableValueChanger(), Maps.class.getDeclaredField("hashtable"), true),
                         new CanChangeCase(new LinkedHashMapValueChanger(),
                                           Maps.class.getDeclaredField("linkedHashMap"),
                                           true),
    ...
    Stream<DynamicTest> Should_Return_True_Or_False_Whether_Values_Are_Different_Or_Not() {
        ...
        return Stream.of(new AreDifferentCase(new HashtableValueChanger(), null, null, false),
                         ...
                         new AreDifferentCase(new HashtableValueChanger(),
                                              new Hashtable<>(mapABC),
                                              new Hashtable<>(mapABC),
                                              false),
                         ...
                         new AreDifferentCase(new LinkedHashMapValueChanger(),
                                              new LinkedHashMap<>(),
                                              new LinkedHashMap<>(),
                                              false),
                         ...
                         new AreDifferentCase(new MapValueChanger(),
                                              new HashMap<>(mapABC),
                                              new HashMap<>(mapABC),
                                              false),
                         ...
                         new AreDifferentCase(new HashMapValueChanger(),
                                              new HashMap<>(mapABC),
                                              new HashMap<>(mapABC),
                                              false),
