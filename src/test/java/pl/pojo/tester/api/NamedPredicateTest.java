...
class NamedPredicateTest {
    ...
    @TestFactory
    Stream<DynamicTest> Should_Return_Expected_To_String() {
        ...
        return Stream.of(
                ...
                new NamedPredicateTestCase(a.negate()
                                            .negate(), "a"),
                new NamedPredicateTestCase(a.negate()
                                            .and(b), "!(a),b"),
                new NamedPredicateTestCase(a.negate()
                ...
                new NamedPredicateTestCase(a.or(b)
                                            .or(c)
                                            .or(d), "a,b,c,d"),
                new NamedPredicateTestCase(a.and(b.and(c.and(d))), "a,b,c,d"),
                new NamedPredicateTestCase(a.and(b)
                                            .and(c)
                                            .and(d), "a,b,c,d"),
    ...
    @Test
    void Should_Return_True_If_Given_Predicate_Returns_True() {
        // given
    ...
    @Test
    void Should_Return_False_If_Given_Predicate_Returns_False() {
        // given
        final NamedPredicate<Object> predicate = new NamedPredicate<>(Predicate.isEqual(null));
